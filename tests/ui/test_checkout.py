...
def test_place_order_register_while_checkout(page, login_page, register_page, payment_page, user_payload):
...
def test_place_order_register_before_checkout(page, login_page, register_page, payment_page, user_payload):
    ...
    expect(page.locator(MainPage.LOGGED_IN)).to_be_visible()
    page.locator(ProductPage.ADD_TO_CART).first.click()
    expect(page.locator(ProductPage.CONTINUE_SHOPPING_BTN)).to_be_visible()
    page.locator(ProductPage.CONTINUE_SHOPPING_BTN).click()
    page.locator(MainPage.CART).first.click()
    page.locator(CheckoutPage.PROCEED_TO_CHECKOUT).click()
    page.locator(CheckoutPage.TEXT).fill("Test order")
...
def test_place_order_login_before_checkout(page, login_page, payment_page, created_user):
    page.locator(MainPage.SIGNUP_LOGIN).click()
