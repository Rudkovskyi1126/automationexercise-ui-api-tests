...
def test_add_products_to_cart(page, product_page):
...
def test_remove_product_from_cart(page, product_page, cart_page):
    product_page.go_to_products_page()
...
def test_product_quantity_in_cart(page, product_page):
    product_page.go_to_products_page()
